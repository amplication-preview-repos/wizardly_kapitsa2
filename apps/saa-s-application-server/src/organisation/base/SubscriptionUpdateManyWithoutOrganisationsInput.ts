...
@InputType()
class SubscriptionUpdateManyWithoutOrganisationsInput {
...
export { SubscriptionUpdateManyWithoutOrganisationsInput as SubscriptionUpdateManyWithoutOrganisationsInput };
