...
@InputType()
class MembershipUpdateManyWithoutOrganisationsInput {
...
export { MembershipUpdateManyWithoutOrganisationsInput as MembershipUpdateManyWithoutOrganisationsInput };
