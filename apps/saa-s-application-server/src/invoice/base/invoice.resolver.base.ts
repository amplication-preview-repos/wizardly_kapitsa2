...
export class InvoiceResolverBase {
  ...
  async createInvoice(
    ...
    return await this.service.createInvoice({
      ...
      data: {
        ...
        billingAccount: args.data.billingAccount
          ? {
              connect: args.data.billingAccount,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => BillingAccount, {
    nullable: true,
    name: "billingAccount",
  })
  @nestAccessControl.UseRoles({
  ...
  async getBillingAccount(
    ...
    const result = await this.service.getBillingAccount(parent.id);
